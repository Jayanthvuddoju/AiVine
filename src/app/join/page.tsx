...
import { Terminal, CheckCircle2, ArrowRight, UserPlus, Award, Zap, MessageSquare, Database, Target, Rocket } from "lucide-react";
    ...
    <div className="min-h-screen relative overflow-hidden bg-transparent">
        ...
        <div className="relative min-h-[70vh] flex flex-col justify-center pt-20 pb-16 overflow-hidden lg:overflow-visible">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
            ...
            <motion.div 
              ...
              className="space-y-6 text-center lg:text-left lg:col-span-5 lg:ml-8"
            >
            ...
            <motion.div 
              ...
              className="w-full h-full min-h-[300px] sm:min-h-[400px] lg:col-span-7 scale-100 lg:scale-110 origin-right lg:-mr-12 translate-y-6 lg:translate-y-10"
            >
              <NetworkDiagram />
            </motion.div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 pt-12 relative z-10">
        <div className="flex flex-col gap-32 mt-16">
          ...
          >
            <h3 className="font-exo-2 text-3xl font-bold text-[#FFFFFF] mb-6">
              Why We're Different
            </h3>
            <p className="text-[#D2D5DC] text-lg leading-relaxed font-light">
          ...
          >
            ...
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,136,255,0.08),transparent_60%)] pointer-events-none" />
            
            <div className="text-center mb-16 relative z-10">
              <h3 className="font-exo-2 text-3xl font-bold text-[#FFFFFF]">
                How It Works
              </h3>
            </div>
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-0 left-0 w-full h-[22rem] z-0 pointer-events-none">
                <svg className="w-full h-full drop-shadow-[0_0_8px_rgba(0,136,255,0.3)] overflow-visible" preserveAspectRatio="none" viewBox="0 0 1000 352">
                  <path 
                    d="M 125 32 L 875 32 C 1000 32, 1000 176, 875 176 L 125 176 C 0 176, 0 320, 125 320 L 875 320" 
                    fill="none" 
                    stroke="rgba(0, 136, 255, 0.4)" 
                    strokeWidth="3" 
                ...
                {howToJoinSteps.map((step, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex flex-col items-center relative group px-2 h-[14rem]">
                      <div className="relative w-16 h-16 rounded-xl bg-[#13161c] border border-white/5 flex items-center justify-center mb-5 group-hover:border-[#0088ff]/50 group-hover:shadow-[0_0_30px_rgba(0,136,255,0.2)] transition-all duration-300 z-10">
                        <Icon className="w-6 h-6 text-[#0088ff] opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300" />
                        <div className="absolute -top-2.5 -right-2.5 w-6 h-6 rounded-full bg-[#0088ff] text-white flex items-center justify-center font-bold text-[10px] shadow-[0_0_10px_rgba(0,136,255,0.4)] border-[2px] border-[#13161c]">
                          {idx + 1}
                        </div>
                      </div>
                      <h4 className="text-white font-bold text-lg mb-3 text-center group-hover:text-[#0088ff] transition-colors">{step.title}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-5xl mx-auto w-full items-start">
            <motion.div
              ...
              transition={{ duration: 1, ease: "easeOut" }}
            >
              <h3 className="font-exo-2 text-2xl font-bold text-[#FFFFFF] mb-8 flex items-center gap-3">
                <Zap className="w-6 h-6 text-[#EAE5D9]" /> What You Get
              </h3>
              <ul className="space-y-5">
                {whatYouGet.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-4">
                    <CheckCircle2 className="w-5 h-5 text-[#EAE5D9] shrink-0 mt-0.5" />
                    <span className="text-base text-[#D2D5DC]">{item}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                {whoWePlace.map((who, idx) => (
                  <div
                    key={idx}
                    className="px-5 py-4 bg-white/5 border border-white/10 text-[#D2D5DC] font-medium text-sm rounded-xl hover:bg-white/10 transition-colors"
                  >
                    {who}
                  </div>
                ))}
          ...
          >
            <h3 className="font-exo-2 text-2xl font-bold text-[#FFFFFF] mb-8 flex justify-center items-center gap-3">
              <Terminal className="w-6 h-6 text-[#EAE5D9]" /> Roles We Place
            </h3>
            <div className="flex flex-wrap justify-center gap-3">
              {rolesWePlace.map((role, idx) => (
                <span
                  key={idx}
                  className="px-4 py-2 bg-white/5 border border-white/10 text-[#D2D5DC] text-sm font-mono rounded-xl hover:bg-white/10 transition-colors cursor-default"
                >
                  {role}
                </span>
              ))}
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 1, ease: "easeOut" }}
            className="max-w-3xl mx-auto w-full text-center p-8 md:p-12 bg-[#EAE5D9]/5 border border-[#EAE5D9]/20 rounded-3xl"
          >
            <h3 className="font-exo-2 text-2xl font-bold text-[#FFFFFF] mb-4 flex items-center justify-center gap-3">
              Your Profile Stays Private
            </h3>
            <p className="text-[#D2D5DC] text-base leading-relaxed">
      ...
      <div className="w-full relative z-10 my-24 overflow-hidden py-16 bg-[#170518]/20 border-y border-white/5">
        <h3 className="font-exo-2 text-2xl font-bold text-[#FFFFFF] mb-16 text-center tracking-wide">
          What Candidates Say
        </h3>
        ...
        <div className="relative flex overflow-hidden w-full group">
          <div className="flex w-max scrolling-marquee gap-8 px-4">
            {testimonials.map((t, idx) => (
              <div key={`t1-${idx}`} className="w-[200px] md:w-[240px] shrink-0 liquid-glass rounded-2xl p-4 flex flex-col justify-between transition-all duration-300 hover:border-white/20">
                <div>
                  <blockquote className="border-l-2 border-[#EAE5D9] pl-3 italic text-[#ffffff] text-[11px] md:text-xs leading-snug mb-2 font-light">
                    "{t.quote}"
                  </blockquote>
                </div>
                <p className="text-[9px] md:text-[10px] text-white/70 font-bold tracking-widest uppercase">
                  — {t.author}
                </p>
              </div>
            ))}
            ...
            {testimonials.map((t, idx) => (
              <div key={`t2-${idx}`} className="w-[200px] md:w-[240px] shrink-0 liquid-glass rounded-2xl p-4 flex flex-col justify-between transition-all duration-300 hover:border-white/20">
                <div>
                  <blockquote className="border-l-2 border-[#EAE5D9] pl-3 italic text-[#ffffff] text-[11px] md:text-xs leading-snug mb-2 font-light">
                    "{t.quote}"
                  </blockquote>
          ...
          <div className="liquid-glass p-8 md:p-10 relative overflow-hidden group transition-all duration-500 hover:-translate-y-1 hover:border-white/20">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Link
                  href="/talent"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-transparent border border-white/20 text-white font-semibold rounded-full text-sm hover:bg-white/5 transition-all duration-300"
                >
