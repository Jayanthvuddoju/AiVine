  ...
  return (
    <div className="overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url(/BurgundyBg.png)' }}
      >
        ...
        <div className="flex w-full h-screen">
          ...
          <div className="flex-1 flex items-center px-8 sm:px-12 lg:px-20 relative z-10 pt-28">
            ...
            >
              ...
              <motion.h1
                ...
                className="font-elianto text-4xl sm:text-5xl md:text-[4.125rem] font-bold tracking-tight leading-[1.08] text-transparent bg-clip-text bg-gradient-to-b from-gray-200 via-gray-400 to-gray-600 drop-shadow-md"
              >
                Where AI Talent <br />
                Takes Root And <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#fda4af] via-[#F43F5E] to-[#881337] relative">
                  Innovation Grows
                </span>
              </motion.h1>
              ...
              >
                <Link
                  href="/hire"
                  className="w-full sm:w-auto px-6 py-3 bg-[#F43F5E] text-white font-semibold rounded-vine hover:bg-[#F43F5E]/90 hover:shadow-lg transition-all duration-300 cursor-pointer text-sm glossy-btn"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2 group">
                    Hire AI Talent
                ...
                <Link
                  href="/join"
                  className="w-full sm:w-auto px-6 py-3 border border-[#f7f7f7]/30 text-[#f7f7f7] font-medium rounded-vine hover:border-[#f7f7f7] hover:bg-[#f7f7f7]/10 transition-all duration-300 cursor-pointer text-sm glossy-btn"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2 group">
                    Join the Network
                    <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
          ...
          <div className="flex-1 relative hidden md:block">
            ...
            <motion.div 
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-[radial-gradient(circle_at_center,rgba(244,63,94,0.4)_0%,transparent_70%)] blur-3xl -z-10" 
            />
            <SplineScene
      ...
      <section className="py-24 bg-transparent relative z-10 border-y border-[#F43F5E]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Ambient Glow */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(244,63,94,0.15)_0%,transparent_70%)] blur-2xl -z-10" />
            
            <div className="text-center space-y-8 heavy-frost-glass p-8 md:p-14 relative group hover:border-[#F43F5E]/30 transition-colors duration-500">
              {/* Top gradient highlight */}
              <div className="absolute top-0 left-1/4 right-1/4 h-[1px] bg-gradient-to-r from-transparent via-[#F43F5E] to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500" />
              
              <div className="space-y-4">
                <p className="font-display text-3xl sm:text-5xl font-bold text-white drop-shadow-sm">
                  Cultivating Growth and <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F43F5E] to-[#fb7185]">Connection</span>
                </p>
              </div>
              ...
              <div className="pt-4 space-y-6">
                ...
                <div className="h-px w-24 bg-gradient-to-r from-transparent via-[#F43F5E]/50 to-transparent mx-auto" />
      ...
      <section className="py-24 bg-transparent relative z-10 border-t border-[#F43F5E]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="liquid-glass p-8 relative overflow-hidden group hover:border-[#F43F5E]/30 transition-all duration-500 hover:-translate-y-1">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(244,63,94,0.4)_0%,transparent_60%)] animate-pulse pointer-events-none opacity-50 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="relative z-10 space-y-8">
                <h3 className="font-display text-2xl font-bold text-white border-b border-white/10 pb-4 flex items-center gap-2 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
                  <span className="text-xs font-mono bg-[#F43F5E] text-root-cream px-2 py-1 rounded-full">For Companies</span>
                  Hiring Pipeline
                </h3>

                <div className="space-y-6">
                  <div className="flex gap-4">
                    <span className="font-mono text-lg font-bold text-[#F43F5E] drop-shadow-[0_0_8px_rgba(244,63,94,0.8)]">01</span>
                    <div>
                  ...
                  <div className="flex gap-4">
                    <span className="font-mono text-lg font-bold text-[#F43F5E] drop-shadow-[0_0_8px_rgba(244,63,94,0.8)]">02</span>
                    <div>
                  ...
                  <div className="flex gap-4">
                    <span className="font-mono text-lg font-bold text-[#F43F5E] drop-shadow-[0_0_8px_rgba(244,63,94,0.8)]">03</span>
                    <div>
                  ...
                  <div className="flex gap-4">
                    <span className="font-mono text-lg font-bold text-[#F43F5E] drop-shadow-[0_0_8px_rgba(244,63,94,0.8)]">04</span>
                    <div>
            ...
            <div className="liquid-glass p-8 relative overflow-hidden group hover:border-[#F43F5E]/30 transition-all duration-500 hover:-translate-y-1">
              ...
              <div className="relative z-10 space-y-8">
                <h3 className="font-display text-2xl font-bold text-white border-b border-white/10 pb-4 flex items-center gap-2 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
                  <span className="text-xs font-mono bg-[#F43F5E] text-white px-2 py-1 rounded-full">For Candidates</span>
                  Career Pathway
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <span className="font-mono text-xs font-bold tracking-widest text-[#F43F5E] uppercase">Why AI VINE</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#F43F5E]/10 flex items-center justify-center text-[#F43F5E] shrink-0">
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#F43F5E]/20 to-vine-green/5 rounded-card blur-3xl transform rotate-3" />
              
              {/* NYC */}
              <div className="liquid-glass p-5 rounded-2xl space-y-4 relative z-10 border border-white/10 hover:border-[#F43F5E]/30 transition-colors shadow-lg">
                <div className="flex justify-between items-center pb-3 border-b border-white/10">
                  <span className="font-mono text-[10px] font-semibold text-[#F43F5E]">TALENT MAP: USA &bull; NYC</span>
                ...
                <div>
                  <p className="text-[10px] font-mono text-[#F43F5E] font-bold uppercase">Northeast Placements</p>
                  ...
                  <span className="inline-block bg-[#F43F5E] text-white text-[9px] font-mono px-2 py-0.5 rounded mt-3">PLACED IN 5 DAYS</span>
                </div>
              </div>
              ...
              <div className="liquid-glass p-5 rounded-2xl space-y-4 relative z-10 border border-white/10 hover:border-[#F43F5E]/30 transition-colors shadow-lg">
                <div className="flex justify-between items-center pb-3 border-b border-white/10">
                  <span className="font-mono text-[10px] font-semibold text-[#F43F5E]">TALENT MAP: USA &bull; AUSTIN</span>
                  <div className="flex gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
                    <span className="w-1.5 h-1.5 rounded-full bg-yellow-400" />
                    <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
                ...
                <div>
                  <p className="text-[10px] font-mono text-[#F43F5E] font-bold uppercase">South Placements</p>
                  ...
                  <span className="inline-block bg-[#F43F5E] text-white text-[9px] font-mono px-2 py-0.5 rounded mt-3">PLACED IN 6 DAYS</span>
                </div>
              </div>
              ...
              <div className="liquid-glass p-5 rounded-2xl space-y-4 relative z-10 border border-white/10 hover:border-[#F43F5E]/30 transition-colors shadow-lg">
                <div className="flex justify-between items-center pb-3 border-b border-white/10">
                  <span className="font-mono text-[10px] font-semibold text-[#F43F5E]">TALENT MAP: USA &bull; CHICAGO</span>
                  <div className="flex gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
                    <span className="w-1.5 h-1.5 rounded-full bg-yellow-400" />
                    <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
                ...
                <div>
                  <p className="text-[10px] font-mono text-[#F43F5E] font-bold uppercase">Midwest Placements</p>
                  ...
                  <span className="inline-block bg-[#F43F5E] text-white text-[9px] font-mono px-2 py-0.5 rounded mt-3">PLACED IN 3 DAYS</span>
                </div>
              </div>
              ...
              <div className="liquid-glass p-5 rounded-2xl space-y-4 relative z-10 border border-white/10 hover:border-[#F43F5E]/30 transition-colors shadow-lg">
                <div className="flex justify-between items-center pb-3 border-b border-white/10">
                  <span className="font-mono text-[10px] font-semibold text-[#F43F5E]">TALENT MAP: USA &bull; SEATTLE</span>
                  <div className="flex gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
                    <span className="w-1.5 h-1.5 rounded-full bg-yellow-400" />
                    <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
                ...
                <div>
                  <p className="text-[10px] font-mono text-[#F43F5E] font-bold uppercase">Pacific NW Placements</p>
                  ...
                  <span className="inline-block bg-[#F43F5E] text-white text-[9px] font-mono px-2 py-0.5 rounded mt-3">PLACED IN 7 DAYS</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Bottom Banner */}
          <div className="mt-16 liquid-glass text-white p-8 relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-8 group transition-all duration-500 hover:-translate-y-1 hover:border-[#F43F5E]/30">
            ...
            <Link
              href="/contact"
              className="w-full md:w-auto px-6 py-3 bg-[#F43F5E] hover:bg-[#F43F5E]/90 text-white font-semibold rounded-vine transition-colors z-10 text-center shrink-0 cursor-pointer glossy-btn"
            >
